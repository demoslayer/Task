...
//       const response = await axios.delete(`http://localhost:8000/api/faqs/${selectedFaqId}`);
...
//               onChange={() => setExpanded(expanded === faq._id ? false : faq._id)}
//               sx={{ mb: 1 }}
//             >
//               <AccordionSummary 
...
const FAQList = () => {
  ...
  const handleAccordionChange = (faqId) => {
